module.exports = {
  ...
  rules: {
    ...
    'react/jsx-props-no-spreading': ['error', { exceptions: ['TextInput', 'NumberInput', 'DateInput'] }] // disable for form elements, cuz react-hook-form input props needs to be desctructured
  }
};
